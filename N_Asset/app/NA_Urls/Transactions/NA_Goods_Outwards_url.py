...
urlpatterns = [
    ...
    url(r'^getEmployee/$', RedirectView.as_view(url='/Transactions/Goods_Receive/IT/getEmployee/',permanent=False,query_string=True),name='redirect-to-getEmployee-from-outwards'),#ambil funtion yang sudah ada di receive view
