...
urlpatterns = [
    ...
    url(r'^Goods_Receive/GA/', include('app.NA_Urls.Transactions.NA_Goods_Receive_GA_url', namespace='NA_Goods_Receive_GA')),
	...
	url(r'^Goods_Disposal/',include('app.NA_Urls.Transactions.NA_Goods_Disposal_url',namespace='NA_Goods_Disposal'))
]